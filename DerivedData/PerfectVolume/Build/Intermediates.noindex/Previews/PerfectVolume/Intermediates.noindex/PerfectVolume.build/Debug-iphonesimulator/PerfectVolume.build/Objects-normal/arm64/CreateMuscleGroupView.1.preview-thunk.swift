...
extension CreateMuscleGroupView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack {
            Form {
                Section {
                    TextField(__designTimeString("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].arg[0].value", fallback: "Muscle group name"), text: $name)
                }.listRowBackground(secondarySystem)
                Section {
                    VStack {
                        Text("Minimum Target Sets: \(Int(minTargetSets))")
                        Slider(value: $minTargetSets, in: __designTimeInteger("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[1].arg[1].value.[0]", fallback: 0)...__designTimeInteger("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[1].arg[1].value.[1]", fallback: 30), step: __designTimeInteger("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[1].arg[2].value", fallback: 1))
                    }
                    .padding()
                    .listRowBackground(secondarySystem)
                    ...
                    VStack {
                        ...
                        Slider(value: $maxTargetSets, in: __designTimeInteger("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[1].arg[1].value.[0]", fallback: 0)...__designTimeInteger("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[1].arg[1].value.[1]", fallback: 30), step: __designTimeInteger("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[1].arg[2].value", fallback: 1))
                    }
                    .padding()
                    .listRowBackground(secondarySystem)
                }
                ...
                Section {
                    Button(action: {
                        ...
                        HStack {
                            Spacer()
                            Text(__designTimeString("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[2].arg[0].value.[0].arg[1].value.[0].arg[0].value.[1].arg[0].value", fallback: "SAVE"))
                ...
                .listRowBackground(textValid(name: name, minTarget: Int(minTargetSets), maxTarget: Int(maxTargetSets)) ? Color(__designTimeString("#8987.[1].[7].property.[0].[0].arg[0].value.[0].arg[0].value.[2].modifier[1].arg[0].value.then.arg[0].value", fallback: "Mint Green")) : Color.gray)
