...
#ifndef PERFECTVOLUME_SWIFT_H
#define PERFECTVOLUME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PerfectVolume",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ExerciseEntity")
...
SWIFT_CLASS_NAMED("MuscleGroupEntity")
@interface MuscleGroupEntity : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface MuscleGroupEntity (SWIFT_EXTENSION(PerfectVolume))
@property (nonatomic, copy) NSUUID * _Nullable id;
@property (nonatomic) int64_t maxTargetSets;
@property (nonatomic) int64_t minTargetSets;
@property (nonatomic, copy) NSString * _Nonnull name;
@property (nonatomic) int64_t setsWorked;
@end
...
- (void)removeExercisesObject:(ExerciseEntity * _Nonnull)value;
