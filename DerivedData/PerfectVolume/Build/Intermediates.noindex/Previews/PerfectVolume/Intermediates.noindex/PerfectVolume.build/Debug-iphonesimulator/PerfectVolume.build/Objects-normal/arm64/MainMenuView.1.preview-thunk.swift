        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    ...
                    case 0:
                        ...
                        NavigationLink(destination: CreateMuscleGroupView()) {
                            Image(systemName: __designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[0].[2].arg[1].value.[0].arg[0].value", fallback: "plus.app.fill"))
                                ...
                                .foregroundColor(Color(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[0].[2].arg[1].value.[0].modifier[1].arg[0].value.arg[0].value", fallback: "Mint Green")))
                                .padding()
                        }
                        .toolbar() {
                            ToolbarItemGroup(placement: .navigationBarTrailing) {
                                Button {
                                    ...
                                    Image(systemName: __designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[0].[2].modifier[0].arg[0].value.[0].arg[1].value.[0].arg[1].value.[0].arg[0].value", fallback: "questionmark.circle")).font(.system(size: __designTimeInteger("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[0].[2].modifier[0].arg[0].value.[0].arg[1].value.[0].arg[1].value.[0].modifier[0].arg[0].value.arg[0].value", fallback: 20))).padding().foregroundColor(Color(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[0].[2].modifier[0].arg[0].value.[0].arg[1].value.[0].arg[1].value.[0].modifier[2].arg[0].value.arg[0].value", fallback: "Mint Green")))
                                }

                            }
                        }
                        .navigationTitle(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[0].[2].modifier[1].arg[0].value", fallback: "Muscle Groups"))
                    ...
                    case 1:
                        List {
                            ForEach(notes) { note in
                                NavigationLink(destination: EditNoteView(note: note)) {
                                    HStack {
                                        Text(note.title ?? __designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[0].arg[0].value.[0].arg[1].value.[0].arg[1].value.[0].arg[0].value.[0].arg[0].value.[0]", fallback: ""))
                                        Spacer()
                                        Text(dateFormatter.string(from: note.date ?? Date())).padding(.trailing, __designTimeFloat("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[0].arg[0].value.[0].arg[1].value.[0].arg[1].value.[0].arg[0].value.[2].modifier[0].arg[1].value", fallback: 10.0))
                                    }
                                }
                        ...
                        NavigationLink(destination: CreateNoteView()) {
                            ZStack {
                                Image(systemName: __designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[2].arg[1].value.[0].arg[0].value.[0].arg[0].value", fallback: "square.fill")).font(.system(size: __designTimeInteger("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[2].arg[1].value.[0].arg[0].value.[0].modifier[0].arg[0].value.arg[0].value", fallback: 40)))
                                    .foregroundColor(Color(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[2].arg[1].value.[0].arg[0].value.[0].modifier[1].arg[0].value.arg[0].value", fallback: "Mint Green")))
                                Image(systemName: __designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[2].arg[1].value.[0].arg[0].value.[1].arg[0].value", fallback: "pencil")).font(.system(size: __designTimeInteger("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[2].arg[1].value.[0].arg[0].value.[1].modifier[0].arg[0].value.arg[0].value", fallback: 30), weight: .bold))
                                    .foregroundColor(.white)

                            }
                                .padding()
                        }
                        .navigationBarTitle(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[1].[2].modifier[0].arg[0].value", fallback: "Workout Notes"))
                    default:
                        NavigationView {
                            Text(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[0].[2].[0].arg[0].value.[0].arg[0].value", fallback: "Error"))
                        }
                    }
                    
                    Spacer()
                    HStack {
                        ForEach(__designTimeInteger("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[2].arg[0].value.[0].arg[0].value.[0]", fallback: 0)..<__designTimeInteger("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].arg[0].value.[2].arg[0].value.[0].arg[0].value.[1]", fallback: 2)) { num in
                            Button(action: {
                                selectedIndex = num
                            }, label: {
                                Spacer()
                ...
                .fullScreenCover(isPresented: $showTutorial) {
                    Text(__designTimeString("#8648.[2].[9].property.[0].[0].arg[0].value.[0].arg[0].value.[1].modifier[0].arg[1].value.[0].arg[0].value", fallback: "Test"))
                }
